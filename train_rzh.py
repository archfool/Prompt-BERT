...
# todo
from prompt_bert.trainers_rzh import CLTrainer
...
def main():
    ...
    if model_args.model_name_or_path:
        if 'roberta' in model_args.model_name_or_path:
            ...
            if model_args.mask_embedding_sentence_org_mlp:
                ...
                model.mlp = BertForMaskedLM.from_pretrained(model_args.model_name_or_path,
                                                            config=config).cls.predictions.transform
    ...
    # todo choose Trainer or CLTrainer
    trainer = Trainer(
        model=model,
        args=training_args,
